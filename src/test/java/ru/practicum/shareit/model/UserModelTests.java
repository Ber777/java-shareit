...
public class UserModelTests {
    ...
    // Тестируем уникальность email (косвенно через аннотацию)
    @Test
    void shouldTestEmailUniqueAnnotation() throws NoSuchFieldException {
        // Проверяем, что поле email имеет аннотацию @Column с unique = true
        var columnAnnotation = user.getClass()
